...
export default function Auth() {
  ...
  // Verifica se há erro nos parâmetros da URL (OAuth callback)
  useEffect(() => {
    ...
    if (error) {
      toast({
        ...
        description: errorDescription || 'Não foi possível fazer login com Google',
        variant: 'destructive',
      });
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      // Nota: Não setamos isLoading para false aqui porque o usuário será redirecionado
    } catch (err) {
      setIsLoading(false);
      toast({
        title: 'Erro',
