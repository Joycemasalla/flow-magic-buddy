                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <div className="min-w-0">
                          <h3 className="font-semibold truncate">{investment.nome}</h3>
                        ...
                        <div className="flex items-center gap-2">
                          {investment.jaInvestido ? (
                            <span className="text-xs text-muted-foreground">
                              Investido em {format(parseISO(investment.dataInvestimento), 'dd/MM', { locale: ptBR })}
                            </span>
                          ) : (
                            <Button
                              size="sm"
                              variant="outline"
                              className="gap-1 text-income border-income/30 hover:bg-income/10"
